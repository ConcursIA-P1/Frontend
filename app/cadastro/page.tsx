      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription>Preencha os dados abaixo para começar sua jornada</CardDescription>
          </CardHeader>
          <CardContent>
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="confirm-password" type="password" placeholder="Digite a senha novamente" required />
              </div>

              <div className="space-y-3">
                <Label>Tipo de conta</Label>
                <RadioGroup defaultValue="aluno" className="flex flex-col space-y-2">
                  <div className="flex items-center space-x-2 border border-border rounded-lg p-3 cursor-pointer hover:bg-muted/50 transition-colors">
                    ...
                    <Label htmlFor="aluno" className="flex-1 cursor-pointer">
                      ...
                      <div className="text-xs text-muted-foreground">Acesso a simulados e assistente IA</div>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 border border-border rounded-lg p-3 cursor-pointer hover:bg-muted/50 transition-colors">
                    <RadioGroupItem value="professor" id="professor" />
                    <Label htmlFor="professor" className="flex-1 cursor-pointer">
                      <div className="font-medium">Professor</div>
                      <div className="text-xs text-muted-foreground">Ferramentas de criação e gestão</div>
                    </Label>
                  </div>
                </RadioGroup>
              </div>
